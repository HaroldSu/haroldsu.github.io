...
Here, for efficiency, we skip the bias correction procedure. Use "Benjamini-Yekutieli" method to adjust p-values to control false discovery rate.
```{r}
...
mySTANCE <- runTest2(object = mySTANCE, 
                     Genes_to_test = genes.sig.1[1:100], 
...
mySTANCE <- varcomp_est(object = mySTANCE, 
                        Genes_to_est = genes.sig.1[1:100],
                        ncores = 1)
```
